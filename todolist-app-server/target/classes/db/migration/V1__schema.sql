...
CREATE TABLE `choices` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_choices_task_id` (`task_id`),
  CONSTRAINT `fk_choices_task_id` FOREIGN KEY (`task_id`) REFERENCES `todolist` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
